...
```
 {"products": [{"id": "68fe1976-473f-4e8a-b162-851d1c8b2e27", "clientId": "401559ed-b24f-4847-aeb1-d49e6f00db9d", "addressId": "da0abd02-a0ae-4620-bcd484344aa59d5d", "type": "Junior Debit", "creationTime": "2023-04-06T05:26:43.968+03:00", "meetingTime": "2023-04-05T13:55:24.968+03:00" }]}
 ```
...
- Встреча - подписание документов для получения продукта (-ов).
- Можно получить несколько продуктов за одну встречу.
#### Свойства встречи:
